...
export function navigateToDetails(countryName: string) {
...
function createBorderBadges(borders: string[], allCountryData: country.Country[]): string {
...
export function renderDetailsPage(countryName: string, allCountryData: any[]) {
...
export function router(allCountryData: any[], applyFiltersAndSearch: () => void) {
